...
public class AtomicIntegerExample {
	...
	static class MyRunnable implements Runnable {
		...
		public void run() {
			...
			System.out.println("Thread " + Thread.currentThread().getName() + " / Previous : " + myPrevCounter); 
			myCounterPlusFive = at.addAndGet(5);		
			System.out.println("Thread " + Thread.currentThread().getName() + " / plus five : " + myCounterPlusFive);
